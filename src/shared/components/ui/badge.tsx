...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold gpu-accelerated transition-all duration-fast ease-smooth focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
      ...
      animation: {
        ...
        interactive: "interactive", // Uses CSS class with semantic timing
      }
    },
    defaultVariants: {
      variant: "default",
